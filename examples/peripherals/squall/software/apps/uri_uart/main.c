/* 
    Advertises using UriBeacon API & implements UART over BLE (based on Nordic's nrf51 app)
    Thomas Zachariah
    6/17/15
 */
...
#define DEV_NAME                        "UARTsq"                                    /**< Name of device. Will be included in the advertising data. */
...
#define URIBEACON_URI                   "goo.gl/xQkHli"                             /**< URI minus the prefix */

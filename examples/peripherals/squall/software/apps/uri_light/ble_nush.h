...
#define BLE_UUID_NUS_SERVICE             0xFF10                       /**< The UUID of the Nordic UART Service. */
#define BLE_UUID_NUS_TX_CHARACTERISTIC   0xFF11                       /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC   0xFF13                       /**< The UUID of the RX Characteristic. */
#define BLE_UUID_NUS_READ_CHARACTERISTIC 0xFF14

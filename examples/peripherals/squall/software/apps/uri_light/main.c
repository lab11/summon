...
#define DEV_NAME                        "SHL "                                      /**< Name of device. Will be included in the advertising data. */
...
#define URIBEACON_URI                   "goo.gl/5GQG9k"                             /**< URI minus the prefix */
...
{
    if (p_data[0]==0x01) led_on(LED_0);
    else if (p_data[0]==0x00) led_off(LED_0);

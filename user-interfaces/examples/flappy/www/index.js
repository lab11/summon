...
var app = {
  ...
  onDeviceReady: function() {
    document.querySelector("img").setAttribute("class","Dis");                                       // bird image in 'disconnected' mode
  ...
  onToggle: function(event) {
    if (document.querySelector("img").getAttribute("class")!="Dis") {                                // if screen touched while connected,
  ...
  onWrite: function(data) {
    document.querySelector("img").setAttribute("class","On");                                        // flap on
    setTimeout(function(){document.querySelector("img").setAttribute("class","Off")},500);           // flap off
  },

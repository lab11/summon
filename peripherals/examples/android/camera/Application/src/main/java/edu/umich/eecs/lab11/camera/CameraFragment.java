...
public class CameraFragment extends Fragment
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBluetoothManager = (BluetoothManager) getActivity().getSystemService(getActivity().BLUETOOTH_SERVICE);
    ...
    private void requestCameraPermission() {
        if (FragmentCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            new PermissionConfirmationDialog().show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
        ...
        public void run() {
            ...
            try {
                ...
                if (null != output) {
                    try {
                        output.close();
                        MediaStore.Images.Media.insertImage(mContext.getContentResolver(),mFile.getAbsolutePath(),mFile.getName(),"");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }

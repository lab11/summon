...
public class DeviceProfile {
    ...
    //Read-write characteristic for Summon client's transmission
    public static UUID CHARACTERISTIC_UUID = shortUUID("B1DC");
    //Read-only characteristic to transmit to Summon
    public static UUID NOTIFICATION_UUID = shortUUID("B1DD");

    // URI of the UI
    public static byte[] URI_AD = uriAd("goo.gl/Uto7sE");

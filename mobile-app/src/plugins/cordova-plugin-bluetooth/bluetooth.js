...
var parse = function (peripheral, success) {
  var advertisement = {};
...
module.exports.scan = function(services, seconds, success, failure) {
  ble.scan(services, seconds, function (peripheral) {
    parse(peripheral, success);
  }, failure);
};

module.exports.startScan = function(services, success, failure) {
  ble.startScan(services, function (peripheral) {
    parse(peripheral, success);
  }, failure);
};

module.exports.connect = function(device_id, success, failure) {
  ble.connect(device_id, function (peripheral) {
    parse(peripheral, success);
  }, failure);
};

module.exports.connectDevice = function(success, failure) {
...
module.exports.disconnectDevice = function(success, failure) {
